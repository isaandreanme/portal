...
class MasukPolicy
{
    ...
    {
        return $user->can('view_any_masuk');
    }
    ...
    {
        return $user->can('delete_any_masuk');
    }
    ...
    {
        return $user->can('force_delete_any_masuk');
    }
    ...
    {
        return $user->can('restore_any_masuk');
    }
