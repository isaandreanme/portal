...
class OverwiewChart extends ApexChartWidget
{
    /**
     * Chart Id
     *
     * @var string
     */
    protected static string $chartId = 'overwiewChart';
    // protected static ?string $footer = '©2023 PT. Fajar Dewi Sejahtera';
     ...
     * @var string|null
     */
    protected static ?string $heading = 'STATUS PMI';
    ...
    protected function getOptions(): array
    {
        ...
        return [
            ...
            'xaxis' => [
                'categories' => ['BARU','PMI AKTIF','PENDING','MD','FINISH','TERBANG'],
                'labels' => [
                    'style' => [
                        'fontFamily' => 'inherit',
                    ],
