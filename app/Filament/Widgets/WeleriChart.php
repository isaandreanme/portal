...
class WeleriChart extends ApexChartWidget
{
    /**
     * Chart Id
     *
     * @var string
     */
    protected static string $chartId = 'weleriChart';
     ...
     * @var string|null
     */
    protected static ?string $heading = 'KANTOR 4';
    protected static ?string $subheading = 'KANTOR CABANG PEMBANTU';
