...
class DataPmiPolicy
{
     ...
     * @return bool
     */
    public function view(User $user, DataPmi $dataPmi): bool
    {
     ...
     * @return bool
     */
    public function update(User $user, DataPmi $dataPmi): bool
    {
     ...
     * @return bool
     */
    public function delete(User $user, DataPmi $dataPmi): bool
    {
     ...
     * @return bool
     */
    public function forceDelete(User $user, DataPmi $dataPmi): bool
    {
     ...
     * @return bool
     */
    public function restore(User $user, DataPmi $dataPmi): bool
    {
     ...
     * @return bool
     */
    public function replicate(User $user, DataPmi $dataPmi): bool
    {
